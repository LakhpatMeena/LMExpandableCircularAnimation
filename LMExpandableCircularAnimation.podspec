...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = 'https://github.com/LakhpatMeena/LMExpandableCircularAnimation'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Lakhpat Meena' => 'lakhpatmeena01@gmail.com' }
  s.source           = { :git => 'https://github.com/LakhpatMeena/LMExpandableCircularAnimation.git', :tag => s.version.to_s }
